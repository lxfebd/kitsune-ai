...
```shell
git clone https://github.com/<your-github-username>/yachiyo-airi.git
cd yachiyo-airi
```
...
Browse the live UI component storyboard by running:
...
```shell
pnpm -F @kitsune/discord-bot start
```
...
```shell
pnpm -F @kitsune/minecraft-bot start
```
...
>
> ```shell
> nr -F @kitsune/minecraft-bot dev
> ```
...
If you are committing images, consider using AVIF format instead of PNG, JPG etc.
...
Navigate to the repository page, click on the **Pull requests** tab, and click on the **New pull request** button, click on the **Compare across forks** link, and select your fork repository.
