import type { ClientConnection, ClientConnector, ClientEvents } from '@kitsune/better-ws'
import type { WebSocketBaseEvent, WebSocketEvent, WebSocketEventOptionalSource, WebSocketEvents } from '@kitsune/server-shared/types'
