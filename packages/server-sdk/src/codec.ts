...
const invalidMessage = 'Invalid Kitsune websocket message.'
...
/** Error thrown when websocket text cannot be parsed as a Kitsune event envelope. */
...
/** Serializes one Kitsune websocket protocol event with SuperJSON. */
