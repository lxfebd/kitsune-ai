...
```shell
ni @kitsune/server-sdk -D # from @antfu/ni, can be installed via `npm i -g @antfu/ni`
pnpm i @kitsune/server-sdk -D
yarn i @kitsune/server-sdk -D
npm i @kitsune/server-sdk -D
```
