...
- framework-specific bindings through subpath exports such as `@kitsune/vishot-runtime/vue`
...
```ts
import { markScenarioReady, resetScenarioReady } from '@kitsune/vishot-runtime'
import {
  ScenarioCanvas,
  ScenarioCaptureRoot,
  ScreenNavigator,
  ...
  useSceneNavigation,
} from '@kitsune/vishot-runtime/vue'
```
