...
import { useSceneReady } from '@kitsune/vishot-runtime/vue'
...
import airiCardShot from '../../../../artifacts/raw/05-kitsune-card.avif'
...
<template>
  ...
  <SceneCaptureLayout name="manual-kitsune-card" :platform-ui-scale="1.25">
    <template #windows>
      <WindowRoot :style="{ left: '50%', top: '84px', transform: 'translateX(-50%)' }">
