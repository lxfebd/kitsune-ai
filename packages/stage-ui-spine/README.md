# @kitsune/stage-ui-spine

Spine 2D scene components and stores for Project Kitsune. Provides Vue components, composables, and utilities for rendering and managing Spine animations within the stage UI.
...
```ts
import { SpineScene } from '@kitsune/stage-ui-spine/components/scenes'
import { useSpineStore } from '@kitsune/stage-ui-spine/stores/spine'
```
