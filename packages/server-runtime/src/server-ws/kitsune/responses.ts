import type { ExtensionIdentity, MessageHeartbeat, MessageHeartbeatKind, MetadataEventSource, WebSocketEvent } from '@kitsune/server-shared/types'

import { ServerErrorMessages } from '@kitsune/server-shared'
import { WebSocketEventSource } from '@kitsune/server-shared/types'
import { nanoid } from 'nanoid'

import packageJSON from '../../../package.json'

/** Creates Kitsune server event metadata and preserves optional parent correlation. */
...
/** Creates Kitsune server response event factories. */
