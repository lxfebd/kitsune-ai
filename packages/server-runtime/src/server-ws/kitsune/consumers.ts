import type { DeliveryConfig } from '@kitsune/server-shared/types'
...
/**
 * Candidate peer metadata used for Kitsune consumer selection.
 */
...
/**
 * Stored Kitsune consumer registration.
 */
...
/**
 * Sticky Kitsune consumer assignment stored by the consumer selector.
 */
...
/**
 * Checks whether a delivery mode targets the Kitsune consumer registry.
 */
...
/**
 * Normalizes delivery mode for Kitsune consumer registration.
 *
 * Before:
...
/**
 * Normalizes Kitsune consumer priority.
 *
 * Before:
 * - NaN
 *
...
/**
 * Selects a concrete peer for Kitsune consumer-style delivery modes.
 *
...
/**
 * Creates the Kitsune consumer delivery orchestrator for websocket peers.
 *
 * The orchestrator owns registration, unregister, listing, selection, and
 * sticky/round-robin cleanup state for Kitsune consumer routing.
 */
