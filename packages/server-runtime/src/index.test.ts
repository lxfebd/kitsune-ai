import type { WebSocketBaseEvent, WebSocketEvents } from '@kitsune/server-shared/types'

import type { ConsumerStickyAssignment } from './server-ws/kitsune/consumers'

import { describe, expect, it } from 'vitest'

import { heartbeatFrameFrom } from './server-ws/kitsune/codec'
import { selectConsumerPeerId } from './server-ws/kitsune/consumers'
import { resolveEventDelivery } from './server-ws/kitsune/routing'
