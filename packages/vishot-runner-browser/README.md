...
This package is the browser capture engine used by scene packages such as `@kitsune/scenarios-stage-tamagotchi-browser`. It provides:
...
```bash
pnpm -F @kitsune/vishot-runner-browser capture -- ../scenarios-stage-tamagotchi-browser --output-dir ../scenarios-stage-tamagotchi-browser/artifacts/final
...
import { captureBrowserRoots } from '@kitsune/vishot-runner-browser'
