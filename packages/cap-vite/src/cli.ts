...
// TODO(audit): hand-rolled CLI / `cap run` argv handling (see resolveCapRunArgs/hasCapacitorTargetArg in native.ts) — if parsing rules keep growing, adopt a dedicated argv library (cac already a dependency)
