# @kitsune/plugin-protocol

Shared protocol contracts for plugin-module communication in Project Kitsune.
...
```ts
import type { WebSocketEvent, WebSocketEventOf, WebSocketEvents } from '@kitsune/plugin-protocol/types'

import { moduleAnnounce, moduleAuthenticate } from '@kitsune/plugin-protocol/types'
```
