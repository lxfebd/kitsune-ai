 ...
 */
export const pluginBindingApiListEventName = 'kitsune:plugin-sdk:apis:client:bindings:list'
/**
 ...
 */
export const pluginBindingApiAnnounceEventName = 'kitsune:plugin-sdk:apis:client:bindings:announce'
/**
 ...
 */
export const pluginBindingApiActivateEventName = 'kitsune:plugin-sdk:apis:client:bindings:activate'
/**
 ...
 */
export const pluginBindingApiUpdateEventName = 'kitsune:plugin-sdk:apis:client:bindings:update'
/**
 ...
 */
export const pluginBindingApiWithdrawEventName = 'kitsune:plugin-sdk:apis:client:bindings:withdraw'
/**
 ...
 */
export const pluginBindingRegistryResourceKey = 'kitsune:plugin-sdk:resources:bindings'
...
export function getKitBindingResourceKey(kitId: string) {
  return `kitsune:plugin-sdk:resources:kits:${kitId}:bindings`
}
