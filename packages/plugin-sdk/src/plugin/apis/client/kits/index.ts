 ...
 */
export const pluginKitApiListEventName = 'kitsune:plugin-sdk:apis:client:kits:list'
/**
 ...
 */
export const pluginKitApiGetCapabilitiesEventName = 'kitsune:plugin-sdk:apis:client:kits:get-capabilities'
/**
 ...
 */
export const pluginKitRegistryResourceKey = 'kitsune:plugin-sdk:resources:kits'
