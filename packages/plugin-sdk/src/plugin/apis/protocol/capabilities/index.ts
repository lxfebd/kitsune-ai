 ...
 */
export const protocolCapabilityWaitEventName = 'kitsune:plugin-sdk:apis:protocol:capabilities:wait'
/**
 ...
 */
export const protocolCapabilitySnapshotEventName = 'kitsune:plugin-sdk:apis:protocol:capabilities:snapshot'
/**
