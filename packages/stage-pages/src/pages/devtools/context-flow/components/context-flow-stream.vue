...
<template>
  <div :class="['flex', 'flex-col', 'gap-2']">
    <div :class="['flex']">
      <Input
        v-model="filterText"
        :placeholder="t('tamagotchi.settings.devtools.pages.context-flow.search-placeholder')"
      />
    </div>
    <div
      ref="streamContainer"
    ...
    >
      ...
      >
        {{ t('tamagotchi.settings.devtools.pages.context-flow.no-data') }}
      </div>
