...
import type { WebSocketBaseEvent, WebSocketEventOf, WebSocketEvents } from '@kitsune/server-sdk'
import type { ChatStreamEvent, ContextMessage } from '@kitsune/stage-ui/types/chat'
...
import { useCharacterOrchestratorStore, useCharacterStore } from '@kitsune/stage-ui/stores/character'
import { useChatOrchestratorStore } from '@kitsune/stage-ui/stores/chat'
import { CHAT_STREAM_CHANNEL_NAME, CONTEXT_CHANNEL_NAME } from '@kitsune/stage-ui/stores/chat/constants'
import { formatContextPromptText } from '@kitsune/stage-ui/stores/chat/context-prompt'
...
import { useContextObservabilityStore } from '@kitsune/stage-ui/stores/devtools/context-observability'
import { useModsServerChannelStore } from '@kitsune/stage-ui/stores/mods/api/channel-server'
import { getEventSourceKey } from '@kitsune/stage-ui/utils'
...
async function sendTestSparkNotify() {
  ...
  // TODO(audit): improve server event — zod/valibot schema validation for better cross-runtime handling (context-flow/index.vue)
  const notify = {
  ...
  <div :class="['flex', 'flex-col', 'gap-6']">
    <div :class="['grid', 'gap-6', 'lg:grid-cols-[360px_1fr]']">
      ...
      <div :class="['flex', 'flex-col', 'gap-2']">
        ...
        <Section :title="t('tamagotchi.settings.devtools.pages.context-flow.raw-event-stream')" icon="i-solar:inbox-line-bold-duotone" inner-class="gap-3" :expand="true">
          <ContextFlowStream
