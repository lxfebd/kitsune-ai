...
import type { IOSpan, IOSubsystem, IOTurn } from '@kitsune/stage-shared'

import { IOSubsystems } from '@kitsune/stage-shared'
  ...
  >
    ...
    >
      ...
      >
        ...
        <span :class="['font-medium']">{{ t('tamagotchi.settings.devtools.pages.io-tracer.no-trace-data') }}</span>
        <span :class="['text-xs mt-1 text-neutral-400/70']">{{ t('tamagotchi.settings.devtools.pages.io-tracer.start-recording-hint') }}</span>
      </div>
    </div>
