...
} from '@kitsune/stage-ui/stores/devtools/plugin-host-debug'
...
import { Button, Callout, Input } from '@kitsune/ui'
...
<template>
  <div :class="['h-full', 'flex', 'flex-col', 'gap-4', 'overflow-y-auto', 'p-4']">
    <Callout
      ...
      theme="orange"
      :label="t('tamagotchi.settings.devtools.pages.plugin-host.unavailable')"
      :description="t('tamagotchi.settings.devtools.pages.plugin-host.unavailable-description')"
    />

    <Callout
      v-if="store.error"
      theme="orange"
      :label="t('tamagotchi.settings.devtools.pages.plugin-host.last-error')"
    ...
    <div :class="['grid', 'gap-2', 'sm:grid-cols-2', 'xl:grid-cols-6']">
      <div :class="['rounded-xl', 'bg-neutral-100', 'p-3', 'dark:bg-neutral-900/70']">
        <div :class="['text-xs', 'uppercase', 'opacity-70']">
          {{ t('tamagotchi.settings.devtools.pages.plugin-host.discovered') }}
        </div>
      ...
      <div :class="['rounded-xl', 'bg-neutral-100', 'p-3', 'dark:bg-neutral-900/70']">
        <div :class="['text-xs', 'uppercase', 'opacity-70']">
          {{ t('tamagotchi.settings.devtools.pages.plugin-host.enabled-label') }}
        </div>
        <div :class="['text-2xl', 'font-semibold']">
      ...
      <div :class="['rounded-xl', 'bg-neutral-100', 'p-3', 'dark:bg-neutral-900/70']">
        <div :class="['text-xs', 'uppercase', 'opacity-70']">
          {{ t('tamagotchi.settings.devtools.pages.plugin-host.loaded') }}
        </div>
        <div :class="['text-2xl', 'font-semibold']">
      ...
      <div :class="['rounded-xl', 'bg-neutral-100', 'p-3', 'dark:bg-neutral-900/70']">
        <div :class="['text-xs', 'uppercase', 'opacity-70']">
          {{ t('tamagotchi.settings.devtools.pages.plugin-host.capabilities') }}
        </div>
        <div :class="['text-2xl', 'font-semibold']">
      ...
      <div :class="['rounded-xl', 'bg-neutral-100', 'p-3', 'dark:bg-neutral-900/70']">
        <div :class="['text-xs', 'uppercase', 'opacity-70']">
          {{ t('tamagotchi.settings.devtools.pages.plugin-host.kits') }}
        </div>
        <div :class="['text-2xl', 'font-semibold']">
          {{ store.kits.length }}
        </div>
    ...
    <div :class="['flex', 'flex-wrap', 'items-center', 'gap-2']">
      <Input
        v-model="filter"
        :placeholder="t('tamagotchi.settings.devtools.pages.plugin-host.filter-placeholder')"
        class="max-w-[440px] min-w-[280px]"
      />
      <Button
        :label="t('tamagotchi.settings.devtools.pages.plugin-host.refresh')"
      ...
      />
      <Button
        :label="t('tamagotchi.settings.devtools.pages.plugin-host.load-enabled')"
    ...
    <div :class="['flex', 'flex-wrap', 'items-center', 'gap-2']">
      <Input
        ...
        :placeholder="t('tamagotchi.settings.devtools.pages.plugin-host.load-by-id-placeholder')"
        class="max-w-[520px] min-w-[320px]"
      />
      <Button
        :label="t('tamagotchi.settings.devtools.pages.plugin-host.load-plugin')"
    ...
    <Section
      :title="t('tamagotchi.settings.devtools.pages.plugin-host.discovered-plugins')"
    ...
    >
      ...
      >
        {{ t('tamagotchi.settings.devtools.pages.plugin-host.no-discovered') }}
      </div>
          ...
          <div :class="['flex', 'flex-wrap', 'items-center', 'justify-between', 'gap-2']">
            ...
            <div :class="['flex', 'flex-wrap', 'items-center', 'gap-2']">
              ...
              <Button
                size="sm"
                variant="secondary"
                :label="t('tamagotchi.settings.devtools.pages.plugin-host.load')"
                icon="i-solar:play-bold-duotone"
              ...
              <Button
                size="sm"
                variant="ghost"
                :label="t('tamagotchi.settings.devtools.pages.plugin-host.unload')"
    ...
    <Section
      :title="t('tamagotchi.settings.devtools.pages.plugin-host.enabled-plugins')"
      icon="i-solar:check-circle-bold-duotone"
      inner-class="gap-2"
    >
      <div :class="['text-sm', 'opacity-80']">
        {{ t('tamagotchi.settings.devtools.pages.plugin-host.enabled-count', { count: enabledPlugins.length }) }}
      </div>
    ...
    <Section
      :title="t('tamagotchi.settings.devtools.pages.plugin-host.loaded-plugins')"
      icon="i-solar:play-circle-bold-duotone"
      inner-class="gap-2"
    >
      <div :class="['text-sm', 'opacity-80']">
        {{ t('tamagotchi.settings.devtools.pages.plugin-host.loaded-count', { count: loadedPlugins.length }) }}
      </div>
    ...
    <Section
      :title="t('tamagotchi.settings.devtools.pages.plugin-host.kits-title')"
    ...
    >
      ...
      >
        {{ t('tamagotchi.settings.devtools.pages.plugin-host.no-kits') }}
      </div>
    ...
    <Section
      :title="t('tamagotchi.settings.devtools.pages.plugin-host.capabilities-title')"
    ...
    >
      <div
        ...
        :class="['text-sm', 'opacity-70']"
      >
        {{ t('tamagotchi.settings.devtools.pages.plugin-host.no-capabilities') }}
      </div>
      <div v-else :class="['grid', 'gap-2']">
        <div
...
meta:
  ...
  descriptionKey: tamagotchi.settings.devtools.pages.plugin-host.description
