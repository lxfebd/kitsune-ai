...
} from '@kitsune/stage-shared/beat-sync'
import { Alert, AudioSpectrumVisualizer } from '@kitsune/stage-ui/components'
import { useSettingsBeatSync } from '@kitsune/stage-ui/stores/settings'
import { Button, FieldCheckbox, FieldRange, SelectTab } from '@kitsune/ui'
      ...
      <div flex="~ col gap-6">
        ...
        <div flex="~ col gap-4">
          <div flex="~ row" items-center justify-between>
            ...
            <button
              :title="t('tamagotchi.settings.devtools.pages.beat-sync.reset-settings')"
