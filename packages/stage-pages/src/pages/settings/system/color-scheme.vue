...
import { ColorPalette, Section } from '@kitsune/stage-ui/components'
...
<template>
  ...
  >
    ...
    <div
      v-motion
      class="color-bar transparency-grid text-[10px] md:text-base sm:text-xs bg-white dark:bg-neutral-900"
      :initial="{ opacity: 0, y: 10 }"
      :enter="{ opacity: 1, y: 0 }"
      :duration="250 + (9 * 10)"
      :delay="9 * 50"
