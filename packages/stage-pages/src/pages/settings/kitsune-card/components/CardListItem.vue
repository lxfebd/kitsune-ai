...
import { CursorFloating } from '@kitsune/stage-ui/components'
...
<template>
  <CursorFloating
    ...
    :class="[
      isSelected
        ...
        : 'border-2 border-black/[0.08] dark:border-white/[0.08]',
    ]"
    bg="white/50 dark:white/[0.03]" backdrop-blur-xl
  ...
  >
    <!-- Card content -->
    <div
      relative flex="~ col 1" justify-between gap-3 overflow-hidden rounded-xl bg="white/80 dark:white/[0.05]" p-5
      transition="all ease-in-out duration-400"
      ...
      <div z-1 flex items-start justify-between gap-2>
        ...
        <div flex shrink-0 items-center gap-2>
          <button
            ...
            :title="t('settings.pages.card.edit-card')"
