...
import type { HearingTranscriptionResult } from '@kitsune/stage-ui/stores/modules/hearing'
  ...
  >
    <div class="flex flex-col gap-6 md:flex-row">
      <ProviderSettingsContainer class="w-full md:w-[40%] space-y-6">
        ...
        >
          <FieldInput
            ...
            :label="t('settings.pages.providers.provider.aliyun-nls.access-key-id')"
            placeholder="LTAI..."
          />

          <FieldInput
            v-model="credentials.accessKeySecret"
            :label="t('settings.pages.providers.provider.aliyun-nls.access-key-secret')"
            type="password"
            placeholder="****************"
          />
          ...
          <FieldInput
            ...
            :label="t('settings.pages.providers.provider.aliyun-nls.app-key')"
            :placeholder="t('settings.pages.providers.provider.aliyun-nls.app-key-placeholder')"
          />

          <FieldCombobox
            v-model="credentials.region"
            :label="t('settings.pages.providers.provider.aliyun-nls.region')"
      ...
      <div class="w-full flex flex-1 flex-col gap-6">
        <div class="rounded-2xl border border-black/[0.06] dark:border-white/[0.06] bg-white/50 dark:bg-white/[0.03] backdrop-blur-2xl p-4 transition-all duration-300 hover:shadow-sm">
