    ...
    <ProviderSettingsContainer>
      ...
      >
        ...
        <ProviderAccountIdInput
          ...
          :label="t('settings.pages.providers.provider.azure-ai-foundry.resource-name')"
          placeholder="..."
          :description="t('settings.pages.providers.provider.azure-ai-foundry.resource-name-description')"
          required
        />
        <ProviderAccountIdInput
          v-model="modelId"
          :label="t('settings.pages.providers.provider.azure-ai-foundry.model-id')"
          placeholder="..."
          :description="t('settings.pages.providers.provider.azure-ai-foundry.model-id-description')"
          required
        />
      </ProviderBasicSettings>
      ...
      <ProviderAdvancedSettings :title="t('settings.pages.providers.common.section.advanced.title')">
        <ProviderAccountIdInput
          v-model="apiVersion"
          :label="t('settings.pages.providers.provider.azure-ai-foundry.api-version')"
          placeholder="e.g. 2025-04-01-preview"
          :description="t('settings.pages.providers.provider.azure-ai-foundry.api-version-description')"
        />
      </ProviderAdvancedSettings>
