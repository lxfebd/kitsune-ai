...
import { FieldRange } from '@kitsune/ui'
  ...
  <Alert v-if="!hasPlayer2" type="error">
    ...
    <template #content>
      <div class="whitespace-pre-wrap break-all">
        <div>
          {{ t('settings.pages.providers.provider.player2-speech.download-hint') }}
          <a href="https://player2.game" target="_blank" rel="noopener noreferrer">
            https://player2.game
          </a>

          <div>
            {{ t('settings.pages.providers.provider.player2-speech.discord-hint') }}
