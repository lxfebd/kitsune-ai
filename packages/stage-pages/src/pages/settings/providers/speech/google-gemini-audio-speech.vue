...
import { FieldCombobox, FieldRange } from '@kitsune/ui'
...
<template>
  ...
  >
    <template #voice-settings>
      ...
      <FieldRange
        v-model="temperature"
        :label="t('settings.pages.providers.provider.common.fields.field.temperature.label')"
        :description="t('settings.pages.providers.provider.common.fields.field.temperature.description')"
        :min="0"
        :max="2"
        :step="0.1"
