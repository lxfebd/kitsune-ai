...
export declare function createAliyunNLSSession(accessKeyId: string, accessKeySecret: string, appKey: string, options?: {
    region?: 'cn-shanghai' | 'cn-shanghai-internal' | 'cn-beijing' | 'cn-beijing-internal' | 'cn-shenzhen' | 'cn-shenzhen-internal';
}): {
    sessionId: string;
    start: (websocketConn: WebSocket, options?: {
        sessionId?: string;
    } & EventStartTranscription["payload"]) => void;
    stop: (websocketConn?: WebSocket, options?: {
        sessionId?: string;
    }) => void;
    onEvent: (data: unknown, cb: (event: ServerEvent) => void) => void;
