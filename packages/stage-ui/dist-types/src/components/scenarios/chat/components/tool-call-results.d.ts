 ...
 */
export declare function createToolCallResultLookup(slices: ChatSlices[], toolResults?: ChatAssistantMessage['tool_results']): Map<string, ChatSlicesToolCallResult>;
/**
 ...
 */
export declare function resolveToolCallBlockState(result: ChatSlicesToolCallResult | undefined): 'executing' | 'done' | 'error';
