...
import { FieldCheckbox, FieldInput } from '@kitsune/ui'
...
<template>
  <div w-full rounded-xl>
    ...
    <div flex="~ col gap-4">
      <FieldInput
        v-model="voice"
        :label="t('settings.pages.modules.speech.sections.section.voice-settings.voice-id')"
        :description="t('settings.pages.modules.speech.sections.section.voice-settings.voice-id-description')"
        placeholder="alloy"
      />
      <FieldCheckbox
        v-model="useSSML"
