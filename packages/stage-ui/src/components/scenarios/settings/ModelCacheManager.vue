...
import { clearModelCache, formatBytes, getModelCacheSize, isModelCached } from '@kitsune/stage-ui/libs/inference'
...
const knownModels = [
  ...
  { id: 'onnx-community/whisper-small', name: 'Whisper ASR' },
...
<template>
  <div
    :class="[
      'flex flex-col gap-3',
      'rounded-lg p-4',
      'border border-solid border-black/[0.06] dark:border-white/[0.06]',
    ]"
  >
    ...
    <div v-if="!loading" flex flex-col gap-1>
      <div
        ...
        :class="[
          ...
          'bg-white/50 dark:bg-white/[0.03]/50',
        ]"
      >
    ...
    <div flex items-center justify-between>
      <Button
        ...
        size="sm"
        :label="t('settings.model-cache.refresh')"
