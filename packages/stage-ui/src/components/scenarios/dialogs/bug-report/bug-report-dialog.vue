    ...
    <DialogPortal>
      ...
      <DialogContent
        :class="[
          ...
          'flex flex-col overflow-hidden rounded-2xl bg-white/90 dark:bg-neutral-900/90 p-6 shadow-xl outline-none',
          'backdrop-blur-2xl border border-black/5 dark:border-white/5',
