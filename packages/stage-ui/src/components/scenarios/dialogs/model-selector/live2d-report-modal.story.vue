...
const warningReport: Live2DValidationReport = {
  ...
  warnings: [
    ...
    'Missing preview image. Kitsune AI can still import this model, but the selector card will use a fallback preview.',
  ],
  checks: [
...
const invalidReport: Live2DValidationReport = {
  ...
  errors: [
    ...
    'BASENAME COLLISION: Filename "texture_00.png" exists in multiple locations: model/textures/texture_00.png, model/expressions/texture_00.png. This causes data loss in Kitsune AI\'s loader.',
  ],
  warnings: [
