...
import { Button, Callout, FieldCombobox } from '@kitsune/ui'
  ...
  <div class="space-y-2">
    ...
    <div class="flex flex-col items-center justify-center py-2">
      ...
      <div v-if="!props.granted" class="mt-3 w-full">
        <Callout theme="orange" :label="t('settings.hearing.microphone-permission-required')">
          <div class="text-sm">
    ...
    <div class="flex flex-wrap gap-2">
      <Button
        ...
        :label="t('settings.hearing.transcription')"
      ...
      <Button
        ...
        :label="t('settings.hearing.auto-send')"
    ...
    <div class="mt-3 w-full">
      <FieldCombobox
        ...
        :label="t('settings.hearing.input-device')"
        ...
        :placeholder="t('settings.hearing.select-microphone')"
        layout="vertical"
      />
    </div>
  </div>
