...
import { Input, TransitionVertical } from '@kitsune/ui'
...
<template>
  <label
    border="1px solid"
    class="scroll-snap-align-start form_voice-card relative flex flex-col overflow-hidden rounded-xl backdrop-blur-xl"
    transition="all duration-200 ease-in-out"
    :class="[
      voiceId === props.voice.id
        ? 'bg-primary-50/80 dark:bg-primary-900/20 border-primary-200 dark:border-primary-800/50'
        : 'bg-white/70 dark:bg-neutral-900/30 border-black/5 dark:border-white/5',
      voiceId === props.voice.id
