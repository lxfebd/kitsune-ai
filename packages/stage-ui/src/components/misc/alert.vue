...
const containerClass = computed(() => {
  switch (props.type) {
    case 'error':
      return ' bg-red-50/50 dark:bg-red-900/20 backdrop-blur-xl border border-red-100/50 dark:border-red-900/30'
    case 'warning':
      return ' bg-amber-50/50 dark:bg-amber-900/20 backdrop-blur-xl border border-amber-100/50 dark:border-amber-900/30'
    case 'success':
      return ' bg-green-50 text-green-700 dark:bg-green-900/30 dark:text-green-300 backdrop-blur-xl border border-green-100/50 dark:border-green-900/30'
    case 'info':
      return ' bg-blue-50 text-blue-700 dark:bg-blue-900/30 dark:text-blue-300 backdrop-blur-xl border border-blue-100/50 dark:border-blue-900/30'
    case 'loading':
      return ' bg-blue-50 text-blue-700 dark:bg-blue-900/30 dark:text-blue-300 backdrop-blur-xl border border-blue-100/50 dark:border-blue-900/30'
  }
  return ''
