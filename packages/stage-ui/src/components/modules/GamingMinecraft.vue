...
<template>
  <div :class="['flex flex-col gap-6']">
    ...
    <div :class="['rounded-2xl border border-black/[0.06] dark:border-white/[0.06] bg-white/50 dark:bg-white/[0.03] backdrop-blur-2xl p-4 transition-all duration-300 hover:shadow-sm hover:shadow-black/[0.02] dark:hover:shadow-black/[0.08]']">
    ...
    <div :class="['rounded-2xl border border-black/[0.06] dark:border-white/[0.06] bg-white/50 dark:bg-white/[0.03] backdrop-blur-2xl p-4 transition-all duration-300 hover:shadow-sm hover:shadow-black/[0.02] dark:hover:shadow-black/[0.08]']">
      ...
      <div v-else :class="['flex flex-col gap-3']">
        <div
          ...
          :key="entry.id"
          :class="['rounded-xl border border-black/[0.06] dark:border-white/[0.06] bg-white/60 dark:bg-white/[0.04] p-3 transition-all duration-300']"
        >
