...
vi.mock('@kitsune/server-sdk', () => ({
  Client: serverSdkMocks.MockClient,
  // NOTICE: align with real enum values in @kitsune/plugin-protocol (kitsune:*, not proj-airi:*).
  WebSocketEventSource: {
    StageTamagotchi: 'kitsune:stage-tamagotchi',
    StageWeb: 'kitsune:stage-web',
  },
}))
