import type { LlmStreamingControlDispatchContext, LlmStreamingControlDispatchEvent } from '@kitsune/pipelines-audio'

import { errorMessageFrom } from '@moeru/std'
import { createStreamingControlParser } from '@kitsune/pipelines-audio'
...
export const useLlmStreamingControlStore = defineStore('llm-streaming-control', () => {
  ...
  const { post: postRemoteCall, data: incomingRemoteCall } = useBroadcastChannel<RemoteCallMessage, RemoteCallMessage>({ name: 'kitsune-streaming-control-turn-calls' })
