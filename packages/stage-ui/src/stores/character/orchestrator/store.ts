...
import { setupAgentSparkNotifyHandler } from '@kitsune/core-agent/agents/spark-notify'
...
export { sparkNotifyCommandSchema } from '@kitsune/core-agent/agents/spark-notify'
