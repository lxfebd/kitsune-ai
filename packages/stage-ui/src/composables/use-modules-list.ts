import type { BeatSyncDetectorState } from '@kitsune/stage-shared/beat-sync'

import { getBeatSyncState, listenBeatSyncStateChange } from '@kitsune/stage-shared/beat-sync'
...
import { useSettingsLlmRouting } from '../stores/settings/llm-routing'
...
export function useModulesList() {
  ...
  const llmRoutingStore = useSettingsLlmRouting()
  ...
  const modulesList = computed<Module[]>(() => [
    {
      ...
      configured: activeModelStore.configured,
      category: 'essential',
    },
    {
      id: 'llm-routing',
      name: t('settings.pages.modules.llm-routing.title'),
      description: t('settings.pages.modules.llm-routing.description'),
      icon: 'i-solar:route-bold-duotone',
      to: '/settings/modules/llm-routing',
      configured: llmRoutingStore.enabled,
      category: 'essential',
    },
    {
      id: 'speech',
    ...
    },
    {
      id: 'persona',
      name: '角色人格',
      description: '人格模式、灵魂定义、称呼设置 — 在角色卡管理中编辑',
