...
export const MODEL_VRAM_ESTIMATES: Record<string, number> = {
  ...
  // Whisper — NOTICE: this legacy estimate is no longer used for device
  // decisions. The whisper adapter requests its allocation from
  // WHISPER_WEBGPU_VRAM_BYTES (q8 era: tiny 0.8 / base 1.2 / small 2.5 GB),
  // keyed under MODEL_NAMES.WHISPER. Kept here only as a fallback reference.
  [MODEL_NAMES.WHISPER]: 630 * 1024 * 1024,
