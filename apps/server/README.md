...
HTTP and WebSocket backend for Kitsune AI. This app owns auth, billing, chat synchronization, gateway forwarding, and server-side observability export.
...
`AUTH_UI_URL=https://accounts.kitsune.build/ui`
...
`ADMIN_UI_URL=https://admin.kitsune.build`
