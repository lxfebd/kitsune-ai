...
- `pnpm -F @kitsune/server typecheck` — ✅ 2026-05-15.
- `pnpm -F @kitsune/server exec vitest run` — ✅ 344/344 pass.
- `pnpm -F @kitsune/stage-ui typecheck` — ✅ 2026-05-15.
- `pnpm -F @kitsune/stage-ui exec vitest run --project node` — ✅
  375/375 pass. (Browser project not run; pre-existing Playwright env
  gap unrelated to this change.)
- `pnpm -F @kitsune/stage-tamagotchi typecheck` — ✅ 2026-05-15.
- `pnpm -F @kitsune/stage-web typecheck` — ✅ 2026-05-15.
