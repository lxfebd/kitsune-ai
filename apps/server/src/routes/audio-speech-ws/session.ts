...
export function createSessionState(
  ...
  const span = tracer.startSpan('llm.gateway.tts.stream', {
    attributes: {
      [KITSUNE_ATTR_GEN_AI_OPERATION_KIND]: 'text_to_speech_stream',
    },
  })
  ...
  async function dialUpstream() {
    ...
    span.setAttribute(KITSUNE_ATTR_GEN_AI_GATEWAY_UPSTREAM_URL, upstreamURL)
    span.setAttribute(KITSUNE_ATTR_GEN_AI_GATEWAY_KEY_ID, entry.id)
