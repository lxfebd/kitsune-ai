...
describe('providerRoutes', () => {
  ...
  it('get / should return 200 even without user (guard disabled)', async () => {
  ...
  // NOTICE: No ownership check in route handler, so any user can update
  it('patch /:id should allow update even for non-owner', async () => {
    // Create another user
