...
const EnvSchema = object({
  ...
  RESEND_FROM_NAME: optional(string(), 'Kitsune AI'),
  ...
  // OpenTelemetry
  OTEL_SERVICE_NAMESPACE: optional(string(), 'kitsune'),
