 ...
 * helper surface only lets Kitsune pass speed. Voice Pack pitch and volume must be
 * encoded before the request reaches unspeech because Kitsune sends pre-built SSML
