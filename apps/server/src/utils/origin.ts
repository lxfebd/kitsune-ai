...
const TRUSTED_EXACT_ORIGINS = [
  'https://kitsune.moeru.ai', // Production web app
  'capacitor://localhost', // Capacitor mobile (iOS)
  'ai.kitsune.pocket://links', // Android deep link
  'https://accounts.kitsune.build', // Standalone auth UI
  'https://server-dev.kitsune-server-auth.pages.dev', // Server-dev standalone auth UI
  'https://admin.kitsune.build', // Standalone admin UI
  'https://server-dev.kitsune-server-admin.pages.dev', // Server-dev standalone admin UI
]
