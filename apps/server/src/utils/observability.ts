// ---------------------------------------------------------------------------
// Span attribute constants (OTel semantic conventions + Kitsune custom)
// ---------------------------------------------------------------------------
...
// Kitsune custom span attributes
export const KITSUNE_ATTR_BILLING_FLUX_CONSUMED = 'kitsune.billing.flux_consumed'
export const KITSUNE_ATTR_GEN_AI_INPUT_MESSAGES = 'kitsune.gen_ai.input.messages'
export const KITSUNE_ATTR_GEN_AI_INPUT_TEXT = 'kitsune.gen_ai.input.text'
export const KITSUNE_ATTR_GEN_AI_OPERATION_KIND = 'kitsune.gen_ai.operation.kind'
export const KITSUNE_ATTR_GEN_AI_OLLAMA_THINK = 'kitsune.gen_ai.ollama.think'
export const KITSUNE_ATTR_GEN_AI_OUTPUT_FULL_TEXT = 'kitsune.gen_ai.output.full_text'
export const KITSUNE_ATTR_GEN_AI_OUTPUT_TEXT = 'kitsune.gen_ai.output.text'
export const KITSUNE_ATTR_GEN_AI_STREAM = 'kitsune.gen_ai.stream'
export const KITSUNE_ATTR_GEN_AI_STREAM_INTERRUPTED = 'kitsune.gen_ai.stream_interrupted'

// Kitsune router gateway span attributes (in-process LLM/TTS routing — KTD-3).
// All prefixed `kitsune.gen_ai.gateway.*` to stay under the existing `kitsune.gen_ai.*`
// namespace already used by `kitsune.gen_ai.stream_interrupted`.
export const KITSUNE_ATTR_GEN_AI_GATEWAY_UPSTREAM_URL = 'kitsune.gen_ai.gateway.upstream.url'
export const KITSUNE_ATTR_GEN_AI_GATEWAY_UPSTREAM_INDEX = 'kitsune.gen_ai.gateway.upstream.index'
export const KITSUNE_ATTR_GEN_AI_GATEWAY_KEY_ID = 'kitsune.gen_ai.gateway.key.id'
export const KITSUNE_ATTR_GEN_AI_GATEWAY_FALLBACK_DEPTH = 'kitsune.gen_ai.gateway.fallback.depth'
export const KITSUNE_ATTR_GEN_AI_GATEWAY_FALLBACK_REASON = 'kitsune.gen_ai.gateway.fallback.reason'
...
export const METRIC_FLUX_CONSUMED = 'kitsune.billing.flux.consumed'

// Kitsune billing — credit/debit visibility beyond raw consumption
export const METRIC_KITSUNE_FLUX_CREDITED = 'kitsune.billing.flux.credited'
...
export const METRIC_KITSUNE_FLUX_UNBILLED = 'kitsune.billing.flux.unbilled'
export const METRIC_KITSUNE_TTS_CHARS = 'kitsune.billing.tts.chars'
export const METRIC_KITSUNE_TTS_PREFLIGHT_REJECTIONS = 'kitsune.billing.tts.preflight_rejections'

// Kitsune observability — self-monitoring for the metric pipeline
export const METRIC_KITSUNE_OBSERVABILITY_READ_ERRORS = 'kitsune.observability.read_errors'
...
export const METRIC_KITSUNE_PRODUCT_EVENTS = 'kitsune.product.events'

// Kitsune revenue — actual money in (smallest currency unit, e.g. cents)
export const METRIC_KITSUNE_STRIPE_REVENUE = 'kitsune.stripe.revenue'

// Kitsune email — transactional delivery health
export const METRIC_KITSUNE_EMAIL_SEND = 'kitsune.email.send'
export const METRIC_KITSUNE_EMAIL_FAILURES = 'kitsune.email.failures'
export const METRIC_KITSUNE_EMAIL_DURATION = 'kitsune.email.duration'

// Kitsune rate limiting — abuse / attack visibility
export const METRIC_KITSUNE_RATE_LIMIT_BLOCKED = 'kitsune.rate_limit.blocked'

// Kitsune GenAI — stream quality
export const METRIC_KITSUNE_GEN_AI_STREAM_INTERRUPTED = 'kitsune.gen_ai.stream.interrupted'
export const METRIC_GEN_AI_CLIENT_FIRST_TOKEN_DURATION = 'gen_ai.client.first_token.duration'

// Kitsune router gateway — in-process LLM/TTS routing fallback / health signals.
//
...
export const METRIC_KITSUNE_GEN_AI_GATEWAY_FALLBACK_COUNT = 'kitsune.gen_ai.gateway.fallback.count'
export const METRIC_KITSUNE_GEN_AI_GATEWAY_UPSTREAM_ERRORS = 'kitsune.gen_ai.gateway.upstream.errors'
export const METRIC_KITSUNE_GEN_AI_GATEWAY_KEY_EXHAUSTED_COUNT = 'kitsune.gen_ai.gateway.key.exhausted'
export const METRIC_KITSUNE_GEN_AI_GATEWAY_SAME_STATUS_EXHAUSTION = 'kitsune.gen_ai.gateway.same_status_exhaustion'
export const METRIC_KITSUNE_GEN_AI_GATEWAY_CONFIG_RELOAD = 'kitsune.gen_ai.gateway.config.reload'
export const METRIC_KITSUNE_GEN_AI_GATEWAY_DECRYPT_FAILURES = 'kitsune.gen_ai.gateway.decrypt.failures'
export const METRIC_KITSUNE_GEN_AI_GATEWAY_SUBSCRIBER_STATE = 'kitsune.gen_ai.gateway.subscriber_state'
export const METRIC_KITSUNE_GEN_AI_GATEWAY_CONFIG_WRITE = 'kitsune.gen_ai.gateway.config.write'
export const METRIC_KITSUNE_GEN_AI_GATEWAY_CONFIG_INVALID_HMAC = 'kitsune.gen_ai.gateway.config.invalid_hmac'
...
export const METRIC_KITSUNE_GEN_AI_GATEWAY_POOL_SLOT_REJECTED = 'kitsune.gen_ai.gateway.pool.slot_rejected'
export const METRIC_KITSUNE_GEN_AI_GATEWAY_POOL_SATURATION_MARKED = 'kitsune.gen_ai.gateway.pool.saturation_marked'
export const METRIC_KITSUNE_GEN_AI_GATEWAY_POOL_INFLIGHT = 'kitsune.gen_ai.gateway.pool.inflight'
