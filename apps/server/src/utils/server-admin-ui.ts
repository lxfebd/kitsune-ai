...
export const DEFAULT_ADMIN_UI_URL = 'https://admin.kitsune.build'
export const SERVER_DEV_API_SERVER_URL = 'https://kitsune-server-dev.up.railway.app'
export const SERVER_DEV_ADMIN_UI_URL = 'https://server-dev.kitsune-server-admin.pages.dev'
