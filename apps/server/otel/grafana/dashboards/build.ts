 ...
 *
 * Run: `pnpm -F @kitsune/server otel:dashboards`
...
/**
 * Kitsune Server Overview dashboard.
 *
 * Reading order:
...
const dashboard = {
  ...
  liveNow: false,
  preload: false,
  tags: ['kitsune', 'observability', 'grafana-cloud'],
  timeSettings: {
    autoRefresh: '30s',
  ...
  title: 'Kitsune AI Server Overview',
  variables,
}

const here = dirname(fileURLToPath(import.meta.url))
const outPath = join(here, 'kitsune-server-overview-cloud.json')
