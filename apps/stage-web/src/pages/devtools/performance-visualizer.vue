...
import { ButtonBar, CheckBar } from '@kitsune/stage-ui/components'
...
const recordingLabel = computed(() => recording.value ? t('stage.devtools.performance-visualizer.stop-recording') : t('stage.devtools.performance-visualizer.start-recording'))
    ...
    <div flex="~ col gap-2">
      <div flex="~ row items-center gap-2">
        ...
        <ButtonBar
          ...
          :text="t('stage.devtools.performance-visualizer.recording')"
