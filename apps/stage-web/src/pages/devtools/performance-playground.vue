...
import { createPlaybackManager, createSpeechPipeline } from '@kitsune/pipelines-audio'
import { ThreeScene } from '@kitsune/stage-ui-three'
import { animations } from '@kitsune/stage-ui-three/assets/vrm'
import { useDelayMessageQueue, useEmotionsMessageQueue } from '@kitsune/stage-ui/composables/queues'
import { llmInferenceEndToken } from '@kitsune/stage-ui/constants'
import { EMOTION_EmotionMotionName_value, EMOTION_VRMExpressionName_value, EmotionThinkMotionName } from '@kitsune/stage-ui/constants/emotions'
import { useAudioContext, useSpeakingStore } from '@kitsune/stage-ui/stores/audio'
...
import { createQueue } from '@kitsune/stream-kit'
        ...
        <div class="h-60 overflow-auto border border-neutral-200/60 rounded-lg p-2 dark:border-neutral-700/60">
          <div v-for="(msg, idx) in chatMessages" :key="idx" class="mb-2">
            <div class="text-[11px] text-neutral-500">
              {{ msg.role === 'user' ? 'User' : t('stage.devtools.assistant-name') }}
            </div>
