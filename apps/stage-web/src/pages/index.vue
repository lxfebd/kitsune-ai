...
import Header from '@kitsune/stage-layouts/components/Layouts/Header.vue'
import InteractiveArea from '@kitsune/stage-layouts/components/Layouts/InteractiveArea.vue'
import MobileHeader from '@kitsune/stage-layouts/components/Layouts/MobileHeader.vue'
import MobileInteractiveArea from '@kitsune/stage-layouts/components/Layouts/MobileInteractiveArea.vue'
import workletUrl from '@kitsune/stage-ui/workers/vad/process.worklet?worker&url'

import { BackgroundProvider } from '@kitsune/stage-layouts/components/Backgrounds'
import { useBackgroundThemeColor } from '@kitsune/stage-layouts/composables/theme-color'
import { useBackgroundStore } from '@kitsune/stage-layouts/stores/background'
import { HoloCoupon } from '@kitsune/stage-ui/components'
import { ViewControlSlider, WidgetStage } from '@kitsune/stage-ui/components/scenes'
