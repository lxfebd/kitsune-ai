...
val androidVersionName = appVersionProperties.getProperty("KITSUNE_VERSION_NAME")
    ?: error("KITSUNE_VERSION_NAME is missing in android/app-version.properties")
val androidVersionCode = appVersionProperties.getProperty("KITSUNE_VERSION_CODE")
    ?.toIntOrNull()
    ?: error("KITSUNE_VERSION_CODE is missing or invalid in android/app-version.properties")
