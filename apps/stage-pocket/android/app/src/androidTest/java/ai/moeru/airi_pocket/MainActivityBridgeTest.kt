...
class MainActivityBridgeTest {
    ...
    fun javascriptInterfaceForwardsCommandsAndNativeEvents() {
        ...
        ActivityScenario.launch(MainActivity::class.java).use { scenario ->
            val bridgeType = evaluateJavascript(scenario, "typeof window.KitsuneHostBridge?.postMessage")
            ...
            assertEquals(
                ...
                evaluateJavascript(
                    ...
                    """
                    (() => {
                      window.KitsuneHostBridge.postMessage(JSON.stringify({
                        kind: 'connect',
                        id: 'socket-1',
