...
<p align="center">
  [<a href="https://kitsune.ayaka.io">Try it</a>]
</p>
...
Stage Pocket adds a host-backed WebSocket bridge for `@kitsune/server-sdk`.

Design constraints:
- keep page loading on secure origins (`https` or app-hosted local origins) to preserve secure-context web APIs
- only implement the WebSocket bridge needed by `@kitsune/server-sdk`
