...
import { errorMessageFromUnknown } from '@kitsune/stage-shared'
  ...
  switch (kind) {
    ...
    case 'unspeech':
      return {
        id: sliceId,
        kind,
        restBaseURL: 'http://kitsune-unspeech.railway.internal:5933',
        streamingEnabled: false,
        streamingUpstreamURL: 'ws://kitsune-unspeech.railway.internal:5933/v1/audio/speech/stream',
