...
import type { ShortcutAccelerator, ShortcutFailureReason } from '@kitsune/stage-shared/global-shortcut'

import { useElectronEventaInvoke } from '@kitsune/electron-vueuse'
import { formatAccelerator, ShortcutFailureReasons } from '@kitsune/stage-shared/global-shortcut'
...
<template>
  <section
    :class="['flex flex-col gap-4 rounded-2xl border border-black/[0.06] dark:border-white/[0.06] bg-white/50 dark:bg-white/[0.03] backdrop-blur-2xl p-4 transition-all duration-300 hover:shadow-sm hover:shadow-black/[0.02] dark:hover:shadow-black/[0.08]']"
