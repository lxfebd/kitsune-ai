...
import { ButtonBar, CheckBar, IconItem } from '@kitsune/stage-ui/components'
...
const menu = computed(() => [
  ...
  {
    title: t('tamagotchi.settings.devtools.pages.displays.title'),
    description: t('tamagotchi.settings.devtools.pages.displays.description'),
    icon: 'i-solar:sledgehammer-bold-duotone',
    to: '/devtools/use-electron-all-displays',
  },
  {
    title: t('tamagotchi.settings.devtools.pages.widgets-calling.title'),
    description: t('tamagotchi.settings.devtools.pages.widgets-calling.description'),
    icon: 'i-solar:sledgehammer-bold-duotone',
    to: '/devtools/widgets-calling',
  },
  {
    title: t('tamagotchi.settings.devtools.pages.context-flow.title'),
    description: t('tamagotchi.settings.devtools.pages.context-flow.description'),
    icon: 'i-solar:chat-square-call-bold-duotone',
    to: '/devtools/context-flow',
  },
  {
    title: t('tamagotchi.settings.devtools.pages.relative-mouse.title'),
    description: t('tamagotchi.settings.devtools.pages.relative-mouse.description'),
    icon: 'i-solar:sledgehammer-bold-duotone',
    to: '/devtools/use-electron-relative-mouse',
  },
  {
    title: t('tamagotchi.settings.devtools.pages.aliyun-nls.title'),
    description: t('tamagotchi.settings.devtools.pages.aliyun-nls.description'),
    icon: 'i-solar:sledgehammer-bold-duotone',
    to: '/devtools/providers-transcription-realtime-aliyun-nls',
  },
  {
    title: t('tamagotchi.settings.devtools.pages.beat-sync.title'),
    description: t('tamagotchi.settings.devtools.pages.beat-sync.description'),
    icon: 'i-solar:chart-bold-duotone',
    to: '/devtools/beat-sync',
  },
  {
    title: t('tamagotchi.settings.devtools.pages.websocket-inspector.title'),
    description: t('tamagotchi.settings.devtools.pages.websocket-inspector.description'),
    icon: 'i-solar:transfer-horizontal-bold-duotone',
    to: '/devtools/websocket-inspector',
  },
  {
    title: t('tamagotchi.settings.devtools.pages.plugin-host.title'),
    description: t('tamagotchi.settings.devtools.pages.plugin-host.description'),
    icon: 'i-solar:bug-bold-duotone',
    to: '/devtools/plugin-host',
  },
  {
    title: t('tamagotchi.settings.devtools.pages.updater.title'),
    description: t('tamagotchi.settings.devtools.pages.updater.description'),
    icon: 'i-solar:restart-bold-duotone',
    to: '/devtools/updater',
  },
  {
    title: t('tamagotchi.settings.devtools.pages.screen-capture.title'),
    description: t('tamagotchi.settings.devtools.pages.screen-capture.description'),
    icon: 'i-solar:screen-share-bold-duotone',
    to: '/devtools/screen-capture',
  },
  {
    title: t('tamagotchi.settings.devtools.pages.vision.title'),
    description: t('tamagotchi.settings.devtools.pages.vision.description'),
    icon: 'i-solar:eye-closed-bold-duotone',
    to: '/devtools/vision',
  },
  {
    title: t('tamagotchi.settings.devtools.pages.global-shortcut.title'),
    description: t('tamagotchi.settings.devtools.pages.global-shortcut.description'),
