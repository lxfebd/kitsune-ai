...
const PANEL = 'settings-panel transition-all duration-300 hover:shadow-sm hover:shadow-black/[0.02] dark:hover:shadow-black/[0.08]'
const CARD_PRIMARY = 'flex flex-col gap-3 rounded-2xl border border-primary-200/60 dark:border-primary-500/20 bg-primary-50/40 dark:bg-primary-500/[0.04] backdrop-blur-2xl p-3 md:p-4 transition-all duration-300 hover:shadow-sm hover:shadow-primary-500/[0.06] dark:hover:shadow-primary-500/[0.08]'
const CARD_MUTED = 'flex flex-col gap-3 rounded-2xl border border-black/[0.06] dark:border-white/[0.06] bg-white/40 dark:bg-white/[0.02] backdrop-blur-2xl p-3 md:p-4 transition-all duration-300 hover:shadow-sm hover:shadow-black/[0.02] dark:hover:shadow-black/[0.06]'
