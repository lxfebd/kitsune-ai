...
<template>
  <section class="flex flex-col gap-3 rounded-2xl border border-primary-200/60 dark:border-primary-500/20 bg-primary-50/40 dark:bg-primary-500/[0.04] backdrop-blur-2xl p-4 md:p-5 transition-all duration-300 hover:shadow-sm hover:shadow-primary-500/[0.06] dark:hover:shadow-primary-500/[0.08]">
