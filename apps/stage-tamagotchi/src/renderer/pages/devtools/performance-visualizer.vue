...
import { ButtonBar } from '@kitsune/stage-ui/components'
  ...
  <div :class="['flex flex-col gap-4', 'pb-6']">
    <div :class="['flex items-center gap-2']">
      <ButtonBar
        ...
        :text="tracing ? t('tamagotchi.settings.devtools.pages.performance-visualizer.tracing-enabled') : t('tamagotchi.settings.devtools.pages.performance-visualizer.tracing-disabled')"
        @click="tracing ? diagnostics.stopTracing() : diagnostics.startTracing()"
      >
        {{ tracing ? t('tamagotchi.settings.devtools.pages.performance-visualizer.stop-tracing') : t('tamagotchi.settings.devtools.pages.performance-visualizer.start-tracing') }}
      </ButtonBar>
    </div>
    ...
    <div :class="['grid gap-3', 'md:grid-cols-2']">
      <section :class="['rounded-2xl border border-neutral-700/60', 'bg-neutral-950/40 p-4']">
        <div :class="['mb-2 text-sm text-neutral-400']">
          {{ t('tamagotchi.settings.devtools.pages.performance-visualizer.window-lifecycle') }}
        </div>
      ...
      <section :class="['rounded-2xl border border-neutral-700/60', 'bg-neutral-950/40 p-4']">
        <div :class="['mb-2 text-sm text-neutral-400']">
          {{ t('tamagotchi.settings.devtools.pages.performance-visualizer.three-render') }}
        </div>
        <div :class="['grid gap-1 text-sm text-neutral-100']">
      ...
      <section :class="['rounded-2xl border border-neutral-700/60', 'bg-neutral-950/40 p-4']">
        <div :class="['mb-2 text-sm text-neutral-400']">
          {{ t('tamagotchi.settings.devtools.pages.performance-visualizer.vrm-update-frame') }}
        </div>
        <div :class="['grid gap-1 text-sm text-neutral-100']">
      ...
      <section :class="['rounded-2xl border border-neutral-700/60', 'bg-neutral-950/40 p-4']">
        <div :class="['mb-2 text-sm text-neutral-400']">
          {{ t('tamagotchi.settings.devtools.pages.performance-visualizer.fade-on-hover-hit-test') }}
        </div>
        <div :class="['grid gap-1 text-sm text-neutral-100']">
      ...
      <section :class="['rounded-2xl border border-neutral-700/60', 'bg-neutral-950/40 p-4']">
        <div :class="['mb-2 text-sm text-neutral-400']">
          {{ t('tamagotchi.settings.devtools.pages.performance-visualizer.vrm-lifecycle') }}
        </div>
        <div :class="['grid gap-1 text-sm text-neutral-100']">
      ...
      <section :class="['rounded-2xl border border-neutral-700/60', 'bg-neutral-950/40 p-4', 'md:col-span-2']">
        <div :class="['mb-2 text-sm text-neutral-400']">
          {{ t('tamagotchi.settings.devtools.pages.performance-visualizer.renderer-resource-snapshots') }}
        </div>
        <div :class="['grid gap-3 text-sm text-neutral-100', 'md:grid-cols-3']">
          <div>
            <div :class="['mb-1 text-xs text-neutral-400 uppercase tracking-wide']">
              {{ t('tamagotchi.settings.devtools.pages.performance-visualizer.after-load') }}
            </div>
          ...
          <div>
            <div :class="['mb-1 text-xs text-neutral-400 uppercase tracking-wide']">
              {{ t('tamagotchi.settings.devtools.pages.performance-visualizer.before-dispose') }}
            </div>
          ...
          <div>
            <div :class="['mb-1 text-xs text-neutral-400 uppercase tracking-wide']">
              {{ t('tamagotchi.settings.devtools.pages.performance-visualizer.after-dispose') }}
            </div>
