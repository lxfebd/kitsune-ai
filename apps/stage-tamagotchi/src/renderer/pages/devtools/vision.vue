...
import type { VisionWorkloadId } from '@kitsune/stage-ui/composables'
import type { SourcesOptions } from 'electron'

import { errorMessageFrom } from '@moeru/std'
import { ProcessingMeter } from '@kitsune/stage-ui/components'
import { VISION_WORKLOADS } from '@kitsune/stage-ui/composables'
import { useVisionOrchestratorStore, useVisionProcessingStore, useVisionStore } from '@kitsune/stage-ui/stores/modules/vision'
import { Button, FieldCheckbox, FieldCombobox, FieldRange, SelectTab } from '@kitsune/ui'
      ...
      >
        ...
        >
          <div :class="['flex', 'items-center', 'justify-between', 'gap-3']">
            <div :class="['flex', 'items-center', 'gap-2']">
              ...
              <div>{{ t('tamagotchi.settings.devtools.pages.vision.capturing') }}</div>
            </div>
        ...
        <div :class="['grid', 'gap-4', 'md:grid-cols-[minmax(0,1.2fr)_minmax(0,0.8fr)]']">
            ...
            <div :class="['rounded-xl', 'bg-neutral-100', 'p-4', 'dark:bg-[rgba(0,0,0,0.3)]']">
              <div :class="['flex', 'flex-col', 'gap-4']">
                ...
                <FieldRange
                  ...
                  :label="t('tamagotchi.settings.devtools.pages.vision.capture-interval')"
                  :description="t('tamagotchi.settings.devtools.pages.vision.capture-interval-description')"
                  :min="500"
                  :max="15000"
                  :step="250"
                ...
                <FieldRange
                  ...
                  :label="t('tamagotchi.settings.devtools.pages.vision.input-downscale')"
                  :description="t('tamagotchi.settings.devtools.pages.vision.input-downscale-description')"
                  :min="25"
                  :max="100"
                  :step="5"
                ...
                <FieldCombobox
                  ...
                  :label="t('tamagotchi.settings.devtools.pages.vision.vision-workload')"
                  :description="t('tamagotchi.settings.devtools.pages.vision.vision-workload-description')"
                  :options="workloadOptions"
                />

                <div :class="['flex', 'items-center', 'gap-3']">
                  <Button
                    :label="isRunning ? t('tamagotchi.settings.devtools.pages.vision.stop-ticker') : t('tamagotchi.settings.devtools.pages.vision.start-ticker')"
                ...
                <div :class="['grid', 'gap-4', 'md:grid-cols-2']">
                  <FieldCheckbox
                    ...
                    :label="t('tamagotchi.settings.devtools.pages.vision.publish-to-character')"
                    :description="t('tamagotchi.settings.devtools.pages.vision.publish-to-character-description')"
                  />
                </div>
              </div>
            </div>
          ...
          <div :class="['flex', 'flex-col', 'gap-4']">
            ...
            <div :class="['rounded-xl', 'bg-neutral-100', 'p-4', 'dark:bg-[rgba(0,0,0,0.3)]']">
              <div :class="['flex', 'items-center', 'justify-between', 'text-xs', 'uppercase', 'tracking-wide', 'text-neutral-400']">
                <span>{{ t('tamagotchi.settings.devtools.pages.vision.last-interpretation') }}</span>
                <span>{{ lastResultAt ? new Date(lastResultAt).toLocaleTimeString() : t('tamagotchi.settings.devtools.pages.vision.idle') }}</span>
              </div>
...
meta:
  layout: settings
  titleKey: tamagotchi.settings.devtools.pages.vision.title
