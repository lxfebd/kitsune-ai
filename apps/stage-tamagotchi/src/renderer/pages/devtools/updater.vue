...
import { useElectronAutoUpdater } from '@kitsune/electron-vueuse'
import { Button, Progress } from '@kitsune/ui'
  ...
  <div :class="['flex flex-col gap-4', 'pb-8']">
    <div :class="['flex flex-wrap gap-2']">
      <Button
        ...
        :label="t('tamagotchi.settings.devtools.pages.updater.check-for-updates')"
      ...
      <Button
        ...
        :label="t('tamagotchi.settings.devtools.pages.updater.download-update')"
      ...
      <Button
        ...
        :label="t('tamagotchi.settings.devtools.pages.updater.restart-to-install')"
    ...
    <div v-if="updateState.status === 'downloading'" :class="['flex flex-col gap-2']">
      <div :class="['flex items-center justify-between text-sm text-neutral-600 dark:text-neutral-300']">
        <span>{{ t('tamagotchi.settings.devtools.pages.updater.downloading') }}</span>
    ...
    <section :class="['rounded-2xl border-2 p-4', 'border-neutral-200 bg-white/70 dark:border-neutral-700/60 dark:bg-neutral-950/40']">
      <div :class="['mb-3 text-sm text-neutral-600 dark:text-neutral-400']">
        {{ t('tamagotchi.settings.devtools.pages.updater.diagnostics') }}
      </div>
...
meta:
  layout: settings
  titleKey: tamagotchi.settings.devtools.pages.updater.title
