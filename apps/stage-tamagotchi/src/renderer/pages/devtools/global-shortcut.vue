...
import { formatAccelerator, parseAccelerator } from '@kitsune/stage-shared/global-shortcut'
...
<template>
  <div class="pb-6 space-y-6">
    <p class="text-sm text-neutral-500 dark:text-neutral-300">
      {{ t('tamagotchi.settings.devtools.pages.global-shortcut.description') }}
    </p>
    ...
    <div class="space-y-3">
      <div class="grid gap-4 md:grid-cols-2">
        <FieldInput
          v-model="form.id"
          :label="t('tamagotchi.settings.devtools.pages.global-shortcut.id')"
          :description="t('tamagotchi.settings.devtools.pages.global-shortcut.id-description')"
          :placeholder="t('tamagotchi.stage.devtools.global-shortcut.id-placeholder')"
        />
        <FieldInput
          v-model="form.acceleratorText"
          :label="t('tamagotchi.settings.devtools.pages.global-shortcut.accelerator')"
          :description="t('tamagotchi.settings.devtools.pages.global-shortcut.accelerator-description')"
          :placeholder="t('tamagotchi.stage.devtools.global-shortcut.accelerator-placeholder')"
        />
      </div>
      <div class="grid gap-4 md:grid-cols-2">
        <FieldInput
          v-model="form.description"
          :label="t('tamagotchi.settings.devtools.pages.global-shortcut.description-label')"
          :description="t('tamagotchi.settings.devtools.pages.global-shortcut.description-desc')"
          :required="false"
        />
        <FieldCheckbox
          v-model="form.receiveKeyUps"
          :label="t('tamagotchi.settings.devtools.pages.global-shortcut.receive-key-ups')"
          :description="t('tamagotchi.settings.devtools.pages.global-shortcut.receive-key-ups-description')"
        />
      </div>
      <div class="flex flex-wrap gap-3">
        <Button variant="primary" :disabled="busy" @click="handleRegister">
          {{ t('tamagotchi.settings.devtools.pages.global-shortcut.register') }}
        </Button>
        <Button variant="secondary" :disabled="busy" @click="refreshList">
          {{ t('tamagotchi.settings.devtools.pages.global-shortcut.refresh-list') }}
        </Button>
        <Button
          class="ml-auto"
          variant="danger"
        ...
        >
          {{ t('tamagotchi.settings.devtools.pages.global-shortcut.unregister-all') }}
        </Button>
      </div>
    ...
    <section class="space-y-2">
      <h3 class="text-sm text-neutral-700 font-semibold dark:text-neutral-200">
        {{ t('tamagotchi.settings.devtools.pages.global-shortcut.active-bindings') }} ({{ active.length }})
      </h3>
      <div
      ...
      >
        {{ t('tamagotchi.settings.devtools.pages.global-shortcut.no-bindings') }}
      </div>
      <div
        v-else
        :class="[
          ...
          <tbody>
            ...
            >
              ...
              <td class="px-3 py-2 text-right">
                ...
                >
                  {{ t('tamagotchi.settings.devtools.pages.global-shortcut.unregister') }}
                </Button>
              </td>
            </tr>
          </tbody>
    ...
    <section class="space-y-2">
      <div class="flex items-center justify-between">
        <h3 class="text-sm text-neutral-700 font-semibold dark:text-neutral-200">
          {{ t('tamagotchi.settings.devtools.pages.global-shortcut.trigger-log') }} ({{ triggers.length }})
        </h3>
        <Button
          size="sm"
          variant="secondary"
          ...
          @click="clearLog"
        >
          {{ t('tamagotchi.settings.devtools.pages.global-shortcut.clear-log') }}
        </Button>
      </div>
      <div
      ...
      >
        {{ t('tamagotchi.settings.devtools.pages.global-shortcut.no-triggers') }}
      </div>
      <div
        v-else
        :class="[
