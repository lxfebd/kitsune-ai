import type { SparkNotifyPerformanceResult, SparkNotifyReactionOptions } from '@kitsune/stage-ui/stores/mods/api/spark-notify-reaction'

import { widgetsIframeBroadcastEvent } from '@kitsune/plugin-sdk-tamagotchi/widgets'
import { sparkNotifyReactionOptionsSchema } from '@kitsune/stage-ui/stores/mods/api/spark-notify-reaction'
