...
import { widgetsIframeInitEvent, widgetsIframePublishEvent } from '@kitsune/plugin-sdk-tamagotchi/widgets'
...
describe('createContext', () => {
  ...
  /**
   * @example
   * expect(initPayload.props.request.responseRoute).toEqual({ namespace: 'kitsune.plugin.gamelet', name: 'response' })
   * expect(publishedPayload.route).toEqual({ namespace: 'kitsune.plugin.gamelet', name: 'response' })
   */
