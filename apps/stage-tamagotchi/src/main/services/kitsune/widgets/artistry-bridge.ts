...
import { artistryGenerateHeadless, artistrySyncConfig, artistryTestComfyUIConnection, errorMessageFromValue } from '@kitsune/stage-shared'
...
async function handleArtistryTrigger(params: {
  ...
  // NOTICE: remix defaults are currently inferred from a fallback chain. Future: move into
  // per-card/provider config to remove this heuristic.
