...
const pathPrefix = '/_kitsune/extensions/'
 ...
 *
 * Use when:
 * - Handling `/_kitsune/extensions/:extensionId/sessions/:assetSessionId/ui/:assetPath` requests
 ...
 * - Emitting URLs for `/_kitsune/extensions/:extensionId/sessions/:assetSessionId/ui/:assetPath`
 *
 * Expects:
