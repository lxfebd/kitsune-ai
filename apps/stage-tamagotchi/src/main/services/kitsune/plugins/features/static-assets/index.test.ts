...
function createSession(assetSessionId: string, extensionId = 'kitsune-plugin-game-chess'): StaticAssetSession {
  return {
    assetSessionId,
    cookieName: `kitsune_extension_asset_session_${assetSessionId}`,
    cookieValue: `cookie-value-${assetSessionId}`,
    cookiePath: `/_kitsune/extensions/${extensionId}/sessions/${assetSessionId}/ui`,
    expiresAt: 123_456,
  }
}
...
describe('createExtensionAssetService', () => {
  ...
  it('creates a cookie-backed asset session before returning the mounted URL', async () => {
    ...
    const result = await service.createAssetSession({
      extensionId: 'kitsune-plugin-game-chess',
      version: '1.0.0',
    ...
    expect(setCookies).toEqual([
      {
        name: 'kitsune_extension_asset_session_asset-session-1',
        value: 'cookie-value-asset-session-1',
        url: 'http://127.0.0.1:48123/_kitsune/extensions/kitsune-plugin-game-chess/sessions/asset-session-1/ui',
        path: '/_kitsune/extensions/kitsune-plugin-game-chess/sessions/asset-session-1/ui',
        expiresAt: 123_456,
      },
    ])
    expect(result).toEqual({
      url: 'http://127.0.0.1:48123/_kitsune/extensions/kitsune-plugin-game-chess/sessions/asset-session-1/ui/assets/app.js',
  ...
  it('removes cookies returned by asset, owner, plugin, and global revocation', async () => {
    ...
    await service.revokeByExtensionId('kitsune-plugin-game-chess')
    ...
    expect(server.revokeByExtensionId).toHaveBeenCalledWith('kitsune-plugin-game-chess')
    ...
    expect(removedCookies).toEqual([
      {
        name: 'kitsune_extension_asset_session_direct-asset-session',
        value: 'cookie-value-direct-asset-session',
        url: 'http://127.0.0.1:48123/_kitsune/extensions/kitsune-plugin-game-chess/sessions/direct-asset-session/ui',
        path: '/_kitsune/extensions/kitsune-plugin-game-chess/sessions/direct-asset-session/ui',
        expiresAt: 123_456,
      },
      {
        name: 'kitsune_extension_asset_session_owner-asset-session',
        value: 'cookie-value-owner-asset-session',
        url: 'http://127.0.0.1:48123/_kitsune/extensions/kitsune-plugin-game-chess/sessions/owner-asset-session/ui',
        path: '/_kitsune/extensions/kitsune-plugin-game-chess/sessions/owner-asset-session/ui',
        expiresAt: 123_456,
      },
      {
        name: 'kitsune_extension_asset_session_plugin-asset-session',
        value: 'cookie-value-plugin-asset-session',
        url: 'http://127.0.0.1:48123/_kitsune/extensions/kitsune-plugin-game-chess/sessions/plugin-asset-session/ui',
        path: '/_kitsune/extensions/kitsune-plugin-game-chess/sessions/plugin-asset-session/ui',
        expiresAt: 123_456,
      },
      {
        name: 'kitsune_extension_asset_session_all-asset-session',
        value: 'cookie-value-all-asset-session',
        url: 'http://127.0.0.1:48123/_kitsune/extensions/kitsune-plugin-game-chess/sessions/all-asset-session/ui',
        path: '/_kitsune/extensions/kitsune-plugin-game-chess/sessions/all-asset-session/ui',
        expiresAt: 123_456,
      },
    ])
  })
  ...
  it('revokes all sessions and removes cookies before stopping the server', async () => {
    ...
    expect(removedCookies).toEqual([
      {
        name: 'kitsune_extension_asset_session_stop-asset-session',
        value: 'cookie-value-stop-asset-session',
        url: 'http://127.0.0.1:48123/_kitsune/extensions/kitsune-plugin-game-chess/sessions/stop-asset-session/ui',
        path: '/_kitsune/extensions/kitsune-plugin-game-chess/sessions/stop-asset-session/ui',
        expiresAt: 123_456,
      },
    ])
  })
