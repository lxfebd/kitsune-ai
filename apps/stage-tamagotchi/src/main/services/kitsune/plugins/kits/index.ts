import type { KitRef } from '@kitsune/plugin-sdk'
import type { ToolKitRuntime } from '@kitsune/plugin-sdk-tamagotchi/tools'
import type { ExtensionHost } from '@kitsune/plugin-sdk/plugin-host'

import type { SetupExtensionHostOptions } from '../types'
import type { GameletOrchestrationRuntime } from './gamelet/orchestration'

import { gameletKit, toolKit } from '@kitsune/plugin-sdk-tamagotchi'
import { TamagotchiToolRegistry } from '@kitsune/plugin-sdk-tamagotchi/tools'
