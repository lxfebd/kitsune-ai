...
import type { ExtensionManifestV1 } from '@kitsune/plugin-sdk/plugin-host'
...
import { extensionManifestV1Schema } from '@kitsune/plugin-sdk/plugin-host'
import { safeParse } from 'valibot'

export const extensionManifestFileName = 'extension.kitsune.json'
 ...
 * - Each extension directory may include `extension.kitsune.json` and optional `package.json`
 *
 * Returns:
