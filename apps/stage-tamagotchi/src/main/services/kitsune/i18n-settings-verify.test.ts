...
describe('settings i18n key resolution (regression: raw keys shown in UI)', () => {
  ...
  it('overseer guidance page keys resolve (tn prefix)', () => {
    for (const k of ['settings.pages.environment.overseer.guidance.title', 'settings.pages.environment.overseer.guidance.description', 'settings.pages.environment.overseer.guidance.enable-label', 'settings.pages.environment.overseer.guidance.enable', 'settings.pages.environment.overseer.guidance.disable', 'settings.pages.environment.overseer.guidance.reset', 'settings.pages.environment.overseer.guidance.reset-busy', 'settings.pages.environment.overseer.guidance.records-count', 'settings.pages.environment.overseer.guidance.empty-records', 'settings.pages.environment.overseer.guidance.threshold-label', 'settings.pages.environment.overseer.guidance.window-label', 'settings.pages.environment.overseer.guidance.cooldown-label', 'settings.pages.environment.overseer.guidance.threshold-value', 'settings.pages.environment.overseer.guidance.window-value', 'settings.pages.environment.overseer.guidance.cooldown-value', 'settings.pages.environment.overseer.guidance.threshold-hint']) {
      expect(typeof resolve(zh, k), `${k} zh`).toBe('string')
